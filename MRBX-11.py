...
def login_lagi334():
	try:
		...
		banner()
		cetak(nel('\t '))
		asu = random.choice([m,m,m])
		cookie=input(f'  [{m} {m}] COOKIE {asu} ')
		...
		print(f'  {b}[{b} {x}]{b} LOGIN SUCESS ');time.sleep(1)
		os.system("python MRBX-11.py")
		exit()
	except Exception as e:
		os.system("rm -f .token.txt")
		os.system("rm -f .cok.txt")
		print(f'  %s[%sx%s]%s COOKIE EXIPRED %s'%(x,k,x,m,x))
		exit()
def menu(id):
	try:
		token = open('.token.txt','r').read()
...
def setting():
	print('')
	print('\x1b[1;97mRANDOM FB 📁 = [ \x1b[1;92m1\x1b[1;97m ] ')
	print('')
	...
	if hu in ['30','030']:
		...
		print('')
		exit()
	print('\x1b[1;97m Mobil.facebook.com = [\x1b[1;92m  01 \x1b[1;97m] ')	
	print('\x1b[1;97m touch.facebook.com = [\x1b[1;92m  02 \x1b[1;97m] ')	
	print('\x1b[1;97m Masb.facebook.com = [\x1b[1;92m  03 \x1b[1;97m] ')
	print('\x1b[1;97m Free.facebook.com = [\x1b[1;92m 04 \x1b[1;97m] ')
	
	hc = input('\x1b[1;97m HALBZHIRA ≛≫ ')
	print('')
	if hc in ['1','01']:
...
\033[1;97m Save in \033[1;32m OK \033[1;97m WITH CRACKED 
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r[MRBX] {P}[{k}\033[1;31m{loop}\033[1;31m{P}/{b}{len(id)}{P}] ↖↗ {P}{H} OK {ok}{P} ↖↗ {P}\033[1;31mCP {cp}{x} ↖↗ {bo}{'{:.0%}'.format(loop/float(len(id)))}{P}  "),
	sys.stdout.flush()
